...
export const AccountMobileBottomNav = () => {
    ...
    <>
      <nav className="fixed mx-2 rounded-2xl mb-2 bottom-0 left-0 right-0 z-50 md:hidden bg-sidebar/50 backdrop-blur-sm border-t border-sidebar-border">
        <div className="flex items-stretch h-16">
          <Link
            href="/"
            className="flex flex-col items-center justify-center gap-1 flex-1 px-1 transition-colors text-muted-foreground hover:text-foreground"
          >
          ...
          {[accountItems[0], accountItems[1]].map((item) => {
